...
registerCommand({
  ...
  handler: () => ({
    ...
    lines: [
      ...
      DIVIDER,
      { content: '  studio       introduction & app launchers', style: 'default' },
      { content: '  log          recent updates in the studio', style: 'default' },
      { content: '  background   work history & education (also: cv)', style: 'default' },
      { content: '  projects     things i\'ve built', style: 'default' },
      { content: '  tapas        dictation and meeting transcripts for Mac', style: 'default' },
      { content: '  writing      blog posts and the newsletter', style: 'default' },
      { content: '  contact      email & elsewhere', style: 'default' },
      { content: '  play         a shell with a sense of humor', style: 'default' },
...
registerCommand({
  ...
  handler: () => ({
    ...
    lines: [
      ...
      { content: `  focus       : AI products · agents · building in public`, style: 'default' },
...
registerCommand({
  ...
  handler: () => ({
    type: 'output',
    lines: [
      { content: 'drwxr-xr-x  studio/', style: 'default' },
      { content: '-rw-r--r--  updates.log', style: 'default' },
      { content: 'drwxr-xr-x  work/', style: 'default' },
      { content: 'drwxr-xr-x  projects/', style: 'default' },
      { content: 'drwxr-xr-x  tapas/', style: 'default' },
      { content: 'drwxr-xr-x  writing/', style: 'default' },
      { content: 'drwxr-xr-x  play/', style: 'default' },
...
registerCommand({
  ...
  handler: () => ({
    ...
    lines: [
      ...
      { content: '  Building AI products and the systems behind them.', style: 'default' },
